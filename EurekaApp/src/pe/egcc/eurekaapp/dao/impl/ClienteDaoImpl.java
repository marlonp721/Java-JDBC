 ...
 * @author Alumno
 */
public class ClienteDaoImpl extends AbstractRowToBean<ClienteBean> implements ClienteDaoCrud{
   ...
   */
    ...
    /**
   * La fila actual de un ResultSet lo convierte
   * en un bean.
   * 
   * @param rs Objeto ResultSet con los datos.
   * @return Retorna la fila actual del ResultSet como bean.
   * @throws SQLException En caso de algun error, se genera 
